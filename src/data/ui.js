export const uiData = [
   ...
   },
   {
      name: "nthToLast",
      desc:
         "- given a word, then a number, this is that position from the end of the word",
      inputs: 2,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "pushIt",
      desc:
         "- given an array, then a string, this will add the string to the end",
      inputs: 2,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "shiftIt",
      desc:
         "- given an array, this will remove the first one and give it to you",
      inputs: 1,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "unShiftIt",
      desc:
         "- given an array, then a string, this will add the string to the beginning",
      inputs: 2,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "shopping",
      desc:
         "- enter up to four items, and this'll turn them into a nice orderly list",
      inputs: 4,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "movinOverOne",
      desc:
         "- given an array, then a string, this will add the string to the end and remove the first entry in the array",
      inputs: 2,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "countingCards",
      desc:
         "- Enter a card value, this'll keep track of your odds and help you make an informed bet.",
      inputs: 1,
      type: "intermediate",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "lookUpProfile",
      desc:
         "- Enter the name of someone in our database, and wether you want their number or likes.",
      inputs: 2,
      type: "intermediate",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "randomRange",
      desc:
         "- Enter a max and a min, and this shows generates a random integer within the range.",
      inputs: 2,
      type: "intermediate",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "splicin",
      desc:
         "- Enter an array and this will chop off the first and last points.",
      inputs: 1,
      type: "intermediate",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- enter an array and this will give you the first three values back",
      inputs: 1,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- enter an array and something to be pushed to the end of the array, using concat",
      inputs: 2,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "getRating",
      desc:
         "- see the average imdb rating of a director's movies (right now only Christopher Nolan)",
      inputs: 1,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- enter an array that contains letters as individual strings and this will alphabetize them",
      inputs: 1,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "splitify",
      desc:
         "- enter a string, this will turn it into an array spliting each letter",
      inputs: 1,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "checkPositive",
      desc:
         "- use Every method to make sure every number in an array is positive",
      inputs: 1,
      type: "functional",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "largestOfFour",
      desc:
         "- enter an array consisting of numbers, and this returns the largest value",
      inputs: 1,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "confirmEnding",
      desc:
         "- enter a string and what you think the ending is, and this will tell you if it is actually the end or not",
      inputs: 2,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "truncateString",
      desc:
         "- if the entered string is longer than the entered number it gets truncated",
      inputs: 2,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "frankenSplice",
      desc:
         "- insert the first array into the second array at whatever number is specified",
      inputs: 3,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "getIndexToIns",
      desc:
         "- enter a list of numbers, this will order the numbers and show you where to put your new number",
      inputs: 2,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "mutation",
      desc:
         "- enter an array, if the second word is in the first then it returns true",
      inputs: 1,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- console logs an entered array, split into smaller arrays specified by the second input",
      inputs: 2,
      type: "algorithm",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- cant start with a number, has to be 5 characters long, and has to end with at least 2 numbers",
      inputs: 1,
      type: "regex",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "- replaces the first three words, with themselves but in reverse order, dont use punctuation",
      inputs: 1,
      type: "regex",
      typeNum: 100,
      isFavorite: false,
